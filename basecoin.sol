...
/**   
   What is Basecoin?
   Basecoin is Token Innovative Network.

   What we at Basecoin has developed is a powerful app,
   a protocol created to maximize profit by shifting the invested
   capital around to different pools. By utilizing the power of smart contracts, 
   we eliminate the need for manual research and allow users to earn a bigger income.
   ...
   ** 100,000,000,000
   ----------------------
   100% Total Supply -> 100,000,000,000 BCO
   90% LP Lock       ->  90,000,000,000 BCO
   5% Team & Dev     ->   5,000,000,000 BCO
   5% Marketing      ->   5,000,000,000 BCO

   WEBSITE   -> https://basecoin.digital/
   TWITTER   -> https://twitter.com/bcotoken
   TELEGRAM  -> https://t.me/bcotoken
   MEDIUM    -> https://medium.com/@bcotokenken

   * * * * * * * * * * * * * *
   We are very pleased with your kindness to cooperate with us.
   Help us develop this project by investing in BCO Tokens
   and we do a lot of development. Thank you.
   From: Owner, Marketing, Divisors | Basecoin
   * * * * * * * * * * * * * *
...
contract Basecoin is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x234C9f844b79B2BD6bebbeF1e16ad41aA4FB24a3); // Marketing Address
